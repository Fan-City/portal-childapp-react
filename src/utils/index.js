// api 地址通用前缀
export const microService1 = 'portalchildapp'
export const microService2 = 'api.microService.com'
...
export function timeFormatter(value) {
  ...
  let da = new Date(value.replace('/Date(', '').replace(')/', '').split('+')[0]) // eslint-disable-next-line
  return (
    da.getFullYear() +
    '-' +
